<template>
  <div class="todoBox">
    ...
    style="width: 90%;margin: 15px 5% 0 5%">
      <el-collapse-item v-for="list in noTodo" :key="list.id">
<!--        自定义标题-->
        <template #title>
          <div class="titleBox">
...
<!--            TODO:展示所选标签组-->
            <div class="todoLabel">这有一超级大大大大堆标签hahahahaha</div>
          </div>
        </template>
<!--        详细内容-->
...
<!--        填写标题-->
        ...
        <el-form-item label="选择一个标签"></el-form-item>
<!--        选择开始时间-->
...
export default {
  ...
  data(){
    return{
      lists:[
        {id:'001',title:'吃饭',text:'描述说明',startTime:'2022/07/21 00:00:00', endTime:'2022/07/21 00:00:00',done:false,overTime:'2022/07/21 00:00:00'},
        {id:'002',title:'睡觉',text:'描述说明',startTime:'', endTime:'',done:false,overTime:''},
        {id:'003',title:'打豆豆',text:'描述说明',startTime:'', endTime:'',done:false,overTime:''},
        {id:'004',title:'打游戏',text:'描述说明',startTime:'', endTime:'',done:false,overTime:''},
        {id:'005',title:'上班',text:'描述说明',startTime:'', endTime:'',done:true,overTime:''}
      ],
      todoTitle:['工作','个人'],
      defaultTime:[
          new Date(2000,1,1,0,0,0),
      ],
      newTodo:{id:'',title:'',text:'',startTime:'', endTime:'',done:false,overTime:''},
